...
options(warn=-1)
my_pair_IR_results_df_name <- "all_pairs_uni_month_2007"
            ...
            for (my_horizon in investment_horizon) {
              for (spread_amplification_factor in spread_amplification_factors){
                for(recalibration_frequency in recalibration_frequencies){
                  ...
                  #               print(spread_amplification_factor)
                  #               
                  my_result_spread_name <- paste(my_country, algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_results_uni_month_2007",sep="")
                  ...
                  if (!is.null(results)){
                    ...
                    print("Reading IR tomorrow")
                    print(my_country)
                    print(IR_spreadbidir_tomorrow)
                    ...
                    new_row_df <- data.frame(second_leg=my_country,
                                             horizon=my_horizon,
...
all_pair_results <- readRDS(paste(outputDataPathStrategyMonth,"all_pairs_uni_month_2007.rds", sep = ""))
