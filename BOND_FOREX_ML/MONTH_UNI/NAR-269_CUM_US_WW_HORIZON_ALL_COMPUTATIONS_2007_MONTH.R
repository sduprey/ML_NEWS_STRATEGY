...
# my_pairs = list (c("US","GB"))

my_countries = list ("US","DE","JP", "GB")
# my_countries = list ("GB")
...
for (my_country in my_countries){
  ...
  my_algorithms <- c("xgboost_caret_cv")
  # my_algorithms <- c("xgboost_caret_cv")
  #   
  ...
  spread_amplification_factors <- c(5,4,3,2) 
            ...
            for (zscore in to_zscore){
              for (my_horizon in investment_horizon) {
                for (spread_amplification_factor in spread_amplification_factors){
                  ...
                  # capture.output(
                  all_results <- compute_alone_strategy_west_first_horizon_withRPID(inputDataPath, outputDataPath, my_country, backtesting_starting_date, backtesting_ending_date, spread_amplification_factor,algorithm, europe_as_third_country, zscore, depth, my_horizon, my_rolling_window, recalibration_frequency)
                  # )
                  
                  SaveDataFrame(all_results$results,outputDataPathMonth,paste(my_country, algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_results_uni_month_2007",sep=""))
                  # SaveDataFrame(all_results$sentiments,outputDataPathMonth,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_sentiments_uni_month_2007",sep=""))
                  SaveDataFrame(all_results$first_leg,outputDataPathMonth,paste(my_country, algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_first_leg_uni_month_2007",sep=""))
                  SaveDataFrame(all_results$features_names,outputDataPathMonth,paste(my_country, algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_features_uni_month_2007",sep=""))
                  
                  SaveDataFrame(all_results$calibration_parameters,outputDataPathMonth,paste(my_country, algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_calibration_uni_month_2007",sep=""))
