...
ExportPlot(g,outputDataPathStrategyWeek,my_result_spread_name)
...
ExportPlot(g,outputDataPathStrategyWeek,paste(my_result_spread_name,"_legs",sep=""))
