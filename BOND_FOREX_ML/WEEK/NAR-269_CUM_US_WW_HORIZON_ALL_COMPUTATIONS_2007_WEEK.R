            ...
            for (zscore in to_zscore){
              for (my_horizon in investment_horizon) {
                for (spread_amplification_factor in spread_amplification_factors){
                  ...
                  SaveDataFrame(all_results$features_names,outputDataPathWeek,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_features_week_2007",sep=""))
