...
#   }
  for (nb in 1:nb_deep_solution){
    ...
    week_us_de_pair_results<-week_us_de_pair_results[-max,]
    print("today")
...
SaveDataFrame(results, outputDataPathStrategyWeek, "all_pairs_results_week_2007")
all_pair_combined_results <- readRDS(paste(outputDataPathStrategyWeek,"all_pairs_results_week_2007.rds", sep = ""))

write.csv(all_pair_combined_results, file = paste(outputDataPathStrategyWeek,"all_pairs_results_week_2007.csv",sep=""), row.names = FALSE)
