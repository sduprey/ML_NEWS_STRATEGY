...
outputDataPathMergingMonth <- paste(outputDataPath,"Month_2007/01_11_2015/",sep="")
...
all_pair_combined_results_12_28 <- readRDS(paste(outputDataPathMergingMonth,"all_pairs_results_month_2007_12_28.rds", sep = ""))
all_pair_combined_results_01_01 <- readRDS(paste(outputDataPathMergingMonth,"all_pairs_results_month_2007_01_01.rds", sep = ""))
...
all_pair_combined_results_12_28$GB_STRATEGY_RETURN <- all_pair_combined_results_01_01$GB_STRATEGY_RETURN
all_pair_combined_results_12_28$GB_STRATEGY_YESTERDAY <- all_pair_combined_results_01_01$GB_STRATEGY_YESTERDAY     
all_pair_combined_results_12_28$GB_STRATEGY_TODAY <- all_pair_combined_results_01_01$GB_STRATEGY_TODAY             
all_pair_combined_results_12_28$GB_STRATEGY_TOMORROW <- all_pair_combined_results_01_01$GB_STRATEGY_TOMORROW
all_pair_combined_results_12_28$GB_SECOND_BOND <- all_pair_combined_results_01_01$GB_SECOND_BOND           
all_pair_combined_results_12_28$GB_FIRST_BOND <- all_pair_combined_results_01_01$GB_FIRST_BOND            
all_pair_combined_results_12_28$GB_FIRST_WEIGHT <- all_pair_combined_results_01_01$GB_FIRST_WEIGHT
all_pair_combined_results_12_28$GB_SECOND_WEIGHT <- all_pair_combined_results_01_01$GB_SECOND_WEIGHT      
all_pair_combined_results_12_28$GB_FIRST_BOND_RETURN <- all_pair_combined_results_01_01$GB_FIRST_BOND_RETURN         
all_pair_combined_results_12_28$GB_SECOND_BOND_OPEN_RETURN <- all_pair_combined_results_01_01$GB_SECOND_BOND_OPEN_RETURN
all_pair_combined_results_12_28$GB_FIRST_BOND_NEXT_RETURN <- all_pair_combined_results_01_01$GB_FIRST_BOND_NEXT_RETURN   
all_pair_combined_results_12_28$GB_SECOND_BOND_NEXT_OPEN_RETURN <- all_pair_combined_results_01_01$GB_SECOND_BOND_NEXT_OPEN_RETURN
all_pair_combined_results_12_28$GB_FIRST_LEG <- all_pair_combined_results_01_01$GB_FIRST_LEG         
all_pair_combined_results_12_28$GB_SECOND_LEG <- all_pair_combined_results_01_01$GB_SECOND_LEG
...
print(all_pair_combined_results_12_28$GB_FIRST_BOND_RETURN - all_pair_combined_results_12_28$DE_FIRST_BOND_RETURN)

all_pair_combined_results_12_28$DE_FIRST_BOND_RETURN <- all_pair_combined_results_12_28$GB_FIRST_BOND_RETURN
all_pair_combined_results_12_28$DE_FIRST_BOND <- all_pair_combined_results_12_28$GB_FIRST_BOND
all_pair_combined_results_12_28$JP_FIRST_BOND_RETURN <- all_pair_combined_results_12_28$GB_FIRST_BOND_RETURN
all_pair_combined_results_12_28$JP_FIRST_BOND <- all_pair_combined_results_12_28$GB_FIRST_BOND

results <- all_pair_combined_results_12_28
old_columns <- colnames(all_pair_combined_results_12_28)
...
# results$JP_WEIGHT <- results$JP_SECOND_WEIGHT/3
# results$GB_WEIGHT <- results$GB_SECOND_WEIGHT/3
colnames(results) <- c(old_columns,"STRATEGY_RETURN","STRATEGY_TODAY","US_WEIGHT","DE_WEIGHT","JP_WEIGHT","GB_WEIGHT")
...
ExportPlot(g,outputDataPathMergingMonth,my_result_spread_name)
...
ExportPlot(g,outputDataPathMergingMonth,paste(my_result_spread_name,"_weights",sep=""))
...
ExportPlot(g,outputDataPathMergingMonth,paste(my_result_spread_name,"_legs",sep=""))
...
SaveDataFrame(results, outputDataPathMergingMonth, "all_pairs_results_month_2007")
write.csv(results, file = paste(outputDataPathMergingMonth,"all_pairs_results_month_2007.csv",sep=""), row.names = FALSE)
