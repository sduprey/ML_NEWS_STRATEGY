...
options(warn=-1)
my_pair_IR_results_df_name <- "all_pairs_month_2007"
            ...
            for (my_horizon in investment_horizon) {
              for (spread_amplification_factor in spread_amplification_factors){
                for(recalibration_frequency in recalibration_frequencies){
                  ...
                  #               print(spread_amplification_factor)
                  #               
                  my_result_spread_name <- paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window,"rec_freq",recalibration_frequency,"spread_results_month_2007",sep="")
...
SaveDataFrame(my_pair_IR_results_df,outputDataPathStrategyMonth,my_pair_IR_results_df_name)

#### results

all_pair_results <- readRDS(paste(outputDataPathStrategyMonth,"all_pairs_month_2007.rds", sep = ""))
...
#     print("All")
#     print(biggest_today_IR)
#     month_us_de_pair_results <- my_pair_results[-max_tomorrow_IR,]
#   }
# }
