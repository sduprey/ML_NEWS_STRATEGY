...
outputDataPath <- outputDataPathStrategyMonth
...
ExportPlot(g,outputDataPathStrategyMonth,"benchmark_comparison")
...
prediction_results <- results[,c("GB_FIRST_PREDICTION", "GB_FIRST_BOND_NEXT_RETURN", "GB_SECOND_PREDICTION", "GB_SECOND_BOND_NEXT_OPEN_RETURN","DE_SECOND_PREDICTION", "DE_SECOND_BOND_NEXT_OPEN_RETURN","JP_SECOND_PREDICTION", "JP_SECOND_BOND_NEXT_OPEN_RETURN")]
colnames(prediction_results) <- c("USPrediction", "USEffective",  "GBPrediction", "GBEffective",  "DEPrediction", "DEEffective",  "JPPrediction", "JPEffective")
...
if (!is.null(prediction_results)){
  ...
  for (my_quantile in c(0.1,1/5,1/3)){
    ...
    print(g)
    ExportPlot(g,outputDataPathStrategyMonth,paste0("US_quantile_quantile",my_quantile))
  }
  ...
  for (my_quantile in c(0.1,1/5,1/3)){
    ...
    g <- ggplot(agg_df, aes(x=Pred_quantile,y=Mean_Ret)) +
      geom_histogram(stat = "identity")
    print(g)
    ExportPlot(g,outputDataPathStrategyMonth,paste0("GB_quantile_quantile",my_quantile))
  }
  ...
  for (my_quantile in c(0.1,1/5,1/3)){
    ...
    g <- ggplot(agg_df, aes(x=Pred_quantile,y=Mean_Ret)) +
      geom_histogram(stat = "identity")
    print(g)
    ExportPlot(g,outputDataPathStrategyMonth,paste0("DE_quantile_quantile",my_quantile))
  }
  ...
  for (my_quantile in c(0.1,1/5,1/3)){
    ...
    g <- ggplot(agg_df, aes(x=Pred_quantile,y=Mean_Ret)) +
      geom_histogram(stat = "identity")
    print(g)
    ExportPlot(g,outputDataPathStrategyMonth,paste0("JP_quantile_quantile",my_quantile))
  }
...
toplot_df <-  melt(uni_df[,c("DATES", "US","US_BOND")],"DATES")
...
g<-ggplot(
  ...
  theme(legend.key.size = unit(0.7, "cm"))
print(g)
ExportPlot(g,outputDataPathMonth,"5_quantiles_US")


toplot_df <-  melt(uni_df[,c("DATES","JP","JP_BOND")],"DATES")
my_title <- paste("Macro Sentiment ML over Ravenpack ESS metrics and taxonomy ",sep="")
g<-ggplot(
  toplot_df,aes(
    x = DATES,y = value,group = variable,color = variable
  ...
  theme(legend.key.size = unit(0.7, "cm"))
print(g)
ExportPlot(g,outputDataPathMonth,"5_quantiles_JP")



toplot_df <-  melt(uni_df[,c("DATES", "DE","DE_BOND")],"DATES")
my_title <- paste("Macro Sentiment ML over Ravenpack ESS metrics and taxonomy ",sep="")
g<-ggplot(
  toplot_df,aes(
    x = DATES,y = value,group = variable,color = variable
  ...
  theme(legend.key.size = unit(0.7, "cm"))
print(g)
ExportPlot(g,outputDataPathMonth,"5_quantiles_DE")


toplot_df <-  melt(uni_df[,c("DATES", "GB","GB_BOND")],"DATES")
my_title <- paste("Macro Sentiment ML over Ravenpack ESS metrics and taxonomy ",sep="")
g<-ggplot(
  toplot_df,aes(
    x = DATES,y = value,group = variable,color = variable
  ...
  theme(legend.key.size = unit(0.7, "cm"))
print(g)
ExportPlot(g,outputDataPathMonth,"5_quantiles_GB")


results$UNI_STRATEGY <-  (uni_df$GB + uni_df$US + uni_df$DE +uni_df$JP)/4
results$SPREAD_STRATEGY <- results$STRATEGY_TODAY 
#### Plotting together the whole benchmark
toplot_df <-  melt(results[,c("DATES", "SPREAD_STRATEGY", "UNI_STRATEGY","EQ_WEIGHTS_BOND")],"DATES")
my_title <- paste("Macro Sentiment ML over Ravenpack ESS metrics and taxonomy ",sep="")
g<-ggplot(
  toplot_df,aes(
    x = DATES,y = value,group = variable,color = variable
...
ExportPlot(g,outputDataPathStrategyMonth,"all_benchmark_comparison")
