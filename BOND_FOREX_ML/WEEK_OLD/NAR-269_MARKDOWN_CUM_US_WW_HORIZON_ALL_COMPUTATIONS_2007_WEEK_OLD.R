          ...
          for (zscore in to_zscore){
            for (my_horizon in investment_horizon) {
              for (spread_amplification_factor in spread_amplification_factors){
                ...
                #               print(spread_amplification_factor)
                #               
                my_result_spread_name <- paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"roll_win",my_rolling_window, "spread_results_week_2007",sep="")
