...
all_pair_combined_results <- readRDS(paste(outputDataPath,"all_pairs_results_week_2007.rds", sep = ""))

# FACT CHECKING

DE_IR_spreadbidir_today <- computeIR(all_pair_combined_results$DE_STRATEGY_RETURN, 5)
print(DE_IR_spreadbidir_today)
GB_IR_spreadbidir_today <- computeIR(all_pair_combined_results$GB_STRATEGY_RETURN, 5)
print(GB_IR_spreadbidir_today)
JP_IR_spreadbidir_today <- computeIR(all_pair_combined_results$JP_STRATEGY_RETURN, 5)
...
equally_mixed_spreadbidir_today <- computeIR(mixed_returns, 5)
