...
train <- read.csv("../input/train.csv",stringsAsFactors = T) #59,381 observations, 128 variables
test <- read.csv("../input/test.csv",stringsAsFactors = T) #19,765 observations, 127 variables - test does not have a response field
