...
outputDataPathMonth <- paste(outputDataPath,"Month_2013/",sep="")
        ...
        for (zscore in to_zscore){
          for (my_horizon in investment_horizon) {
            for (spread_amplification_factor in spread_amplification_factors){
              ...
              SaveDataFrame(all_results$results,outputDataPathMonth,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_results_month_2013",sep=""))
              # SaveDataFrame(all_results$sentiments,outputDataPathMonth,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_sentiments_month_2013",sep=""))
              SaveDataFrame(all_results$first_leg,outputDataPathMonth,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_first_leg_month_2013",sep=""))
              SaveDataFrame(all_results$second_leg,outputDataPathMonth,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_second_leg_month_2013",sep=""))
