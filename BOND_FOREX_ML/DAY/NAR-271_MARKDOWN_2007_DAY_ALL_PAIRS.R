...
for (my_pair in my_pairs){
  ...
  my_result_spread_name_root <- paste(my_pair[2],"day_2007_all_pairs",sep="")
  for (nb in 1:3){
    ...
    RP_ReturnStats(ReturnSerie,1,TRUE,WeightMatrix,0.05,F)
    ...
    ExportPlot(g,outputDataPathDay,my_result_spread_name)
    ...
    ExportPlot(g,outputDataPathDay,paste(my_result_spread_name,"_weights",sep=""))
    ...
    ExportPlot(g,outputDataPathDay,paste(my_result_spread_name,"_legs",sep=""))
    ...
    g<-ggplot(
      ...
      theme(legend.key.size = unit(0.7, "cm"))
    print(g)          
    ExportPlot(g,outputDataPathDay,paste(my_result_spread_name,"bis",sep=""))
...
for (my_pair in my_pairs){
  ...
  month_us_de_pair_results <- all_pair_results[all_pair_results$second_leg == my_pair[2],]
  my_result_spread_name_root <- paste(my_pair[2],"day_2007_all_pairs_bis",sep="")
  for (nb in 1:3){
    my_result_spread_name <- paste(my_result_spread_name_root, nb,sep="")
