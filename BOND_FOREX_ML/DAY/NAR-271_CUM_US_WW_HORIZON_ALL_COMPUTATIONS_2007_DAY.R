        ...
        for (zscore in to_zscore){
          for (my_horizon in investment_horizon) {
            for (spread_amplification_factor in spread_amplification_factors){
              ...
              SaveDataFrame(all_results$results,outputDataPathWeek,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_results_day_2007",sep=""))
              SaveDataFrame(all_results$sentiments,outputDataPathWeek,paste(my_pair[1], my_pair[2], algorithm,"EU",europe_as_third_country,"ZS",zscore,"depth",depth,"amp",spread_amplification_factor,"inv_hor",my_horizon,"spread_sentiments_day_2007",sep=""))
