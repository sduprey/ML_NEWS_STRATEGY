...
all_pair_results <- readRDS(paste(outputDataPath,"all_pairs_week_2007.rds", sep = ""))
...
write.csv(all_pair_combined_results, file = paste(outputDataPath,"all_pairs_results_week_2007.csv",sep=""), row.names = FALSE)
