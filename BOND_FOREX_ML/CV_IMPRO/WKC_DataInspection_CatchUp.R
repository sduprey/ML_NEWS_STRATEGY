...
sum(is.na(MyTrainData[,first_quarter_minutes]))
sum(is.na(MyTrainData[,second_quarter_minutes]))
head(MyTrainData$Ret_PlusOneQuarter)
head(MyTrainData$Ret_PlusTwoQuarter)
