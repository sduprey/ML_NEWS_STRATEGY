...
SaveDataFrame(results$prediction,outputDataPath,paste(algorithm_used,"resultsM1",sep=""))
## saving the first model xgb forest
SaveDataFrame(results$model,outputDataPath,paste(algorithm_used,"modelM1",sep=""))
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM1",sep=""))
...
# parametersM1 <- readRDS(paste(outputDataPath,paste(algorithm_used,"parametersM1.rds",sep=""), sep = ""))
...
results <- RP_SimplePredictNextReturn(algorithm_used,my_predicting_columns , output_one_column, MyTrainData, MyTestData,MyTrainData$Weight_Daily)
## saving the first model prediction
...
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM2",sep=""))
M2_Ret_PlusOne <- results$prediction
# ### Reading back the results
# predictionM2 <- readRDS(paste(outputDataPath,paste(algorithm_used,"resultsM2.rds",sep=""), sep = ""))
...
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM21",sep=""))
M21_Ret_PlusOne <- results$prediction
# ### Reading back the results
# predictionM21 <- readRDS(paste(outputDataPath,paste(algorithm_used,"resultsM21.rds",sep=""), sep = ""))
...
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM3",sep=""))
M3_Ret_PlusTwo <- results$prediction
# ### Reading back the results
# predictionM3 <- readRDS(paste(outputDataPath,paste(algorithm_used,"resultsM3.rds",sep=""), sep = ""))
...
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM31",sep=""))
M31_Ret_PlusTwo <- results$prediction
# ### Reading back the results
# predictionM31 <- readRDS(paste(outputDataPath,paste(algorithm_used,"resultsM31.rds",sep=""), sep = ""))
...
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM32",sep=""))
M32_Ret_PlusTwo <- results$prediction
# ## Reading back the results
# predictionM32 <- readRDS(paste(outputDataPath,paste(algorithm_used,"resultsM32.rds",sep=""), sep = ""))
...
results <- RP_SimplePredictNextReturn(algorithm_used,my_predicting_columns , output_one_column, MyTrainData, MyTestData, MyTrainData$Weight_Daily)
## saving the first model prediction
SaveDataFrame(results$prediction,outputDataPath,paste(algorithm_used,"resultsM321",sep=""))
## saving the first model xgb forest
SaveDataFrame(results$model,outputDataPath,paste(algorithm_used,"modelM321",sep=""))
SaveDataFrame(results$parameters,outputDataPath,paste(algorithm_used,"parametersM321",sep=""))
...
rownames(data_matrix) <- seq(1,120000)
...
# Third mixing methodology
Ret_PlusTwoQuarter <- M1_Ret_PlusTwoQuarter
print(length(Ret_PlusTwoQuarter))
Ret_PlusTwo <- (M32_Ret_PlusTwo)
Ret_PlusOne <- (M21_Ret_PlusOne)
print(length(Ret_PlusOne))
...
SaveDataFrame(data_matrix,outputDataPath,paste0("pre_submission3",algorithm_used))
