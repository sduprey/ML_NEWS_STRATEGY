...
for(my_metric in my_metrics){
  ...
  filename <- getPlotBestProfiles("GROUP",dataMetricTrimmed,all_group_events,all_category_events,my_metric)
  print(filename)
  
  filename <- getPlotBestProfiles("CATEGORY",dataMetricTrimmed,all_group_events,all_category_events,my_metric)
  print(filename)
...
#   RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/returns_group_average_profile_ci")
#   print(results$gret)
#   RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/volatility_group_average_profile_ci")
#   print(results$gvol)  
#   RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/volume_group_average_profile_ci")
#   print(results$gvolu)  
#   
#   ##########################
#   ##########################
...
#   #   # Render your graph
#   #   RP_ExportPlot(gplot = g,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/group_stat_",my_metric))   
#   #   
#   
#   
#   
...
#   print("outputing an average graphic for our metric group")
#   results <- RP_PlotProfile(rowProfile)
#   RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/returns_category_average_profile_ci")
#   print(results$gret)
#   RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/volatility_category_average_profile_ci")
#   print(results$gvol)  
#   RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/volume_category_average_profile_ci")
#   print(results$gvolu)  
#   
#   ##########################
#   ##########################
