...
RP_PlotCIIntervalSuperposed <- function(DataFramePos, DataFrameNeg, Title = "", FullExportingPath=NULL) {
  ...
  DataFrame$POS_CI_LOW <- 1/2*( DataFrame$POS_CI_LOW + as.numeric(mav(DataFrame$POS_CI_LOW)) )
  DataFrame$POS_CI_HIGH <- 1/2*(DataFrame$POS_CI_HIGH + mav(DataFrame$POS_CI_HIGH))
  DataFrame$POS_MEAN <- 1/2*(DataFrame$POS_MEAN +mav(DataFrame$POS_MEAN))
  DataFrame$NEG_MEAN <- 1/2*(DataFrame$NEG_MEAN + mav(DataFrame$NEG_MEAN))
  DataFrame$NEG_CI_LOW <-  1/2*(DataFrame$NEG_CI_LOW+ mav(DataFrame$NEG_CI_LOW))
  DataFrame$NEG_CI_HIGH <- 1/2*(DataFrame$NEG_CI_HIGH+  mav(DataFrame$NEG_CI_HIGH))
...
load(file = paste0(outputDataPath, "dualGroups.RData"))
sentiment<-"POSITIVE"
...
# RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"split_bigdataf_returns_group_average_profile_ci"))
print(results$gret)
...
RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_returns_category_average_profile_ci"))
print(results$gret)
RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_volatility_category_average_profile_ci"))
print(results$gvol)  
RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_volume_category_average_profile_ci"))
print(results$gvolu)  
RP_ExportPlot(results$gstats,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_significance_category_average_profile_ci"))
...
print("outputing an average graphic for our metric group")
sentiment <- "POSITIVE"
rowProfile <- sent_results_group[sentiment] 
results <- RP_PlotProfile(rowProfile)
RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_returns_group_average_profile_ci"))
print(results$gret)
RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_volatility_group_average_profile_ci"))
print(results$gvol)  
RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_volume_group_average_profile_ci"))
print(results$gvolu)  
RP_ExportPlot(results$gstats,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_significance_group_average_profile_ci"))
print(results$gstats)  
RP_ExportPlot(results$gstatscombi,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",sentiment,my_metric,"split_bigdata_significance_group_average_profile_ci"))
