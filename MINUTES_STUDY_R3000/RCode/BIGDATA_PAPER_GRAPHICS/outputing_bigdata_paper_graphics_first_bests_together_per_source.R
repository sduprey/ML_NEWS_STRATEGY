...
writeHTMLPictures <- function(data, file){
  ...
  my_formated_table <- formattable(data, list(
    ...
    FREQUENCY = color_tile("red","green"),
    RETURN = color_tile("red","green"),
    VOLATILITY = color_tile("red","green"),
...
#     
    writeHTMLPictures(data = tableToSave,file=paste0(outputDataPath,"PAPER_PICTURES/TABLES/",my_source,my_metric,"bigdata_best_categories_html.png"))

    tableToSave <- tableToSave[1:table_size_limit,]
    writeHTMLPictures(data = tableToSave,file=paste0(outputDataPath,"PAPER_PICTURES/TABLES/",my_source,my_metric,"clean_bigdata_best_categories_html.png"))
