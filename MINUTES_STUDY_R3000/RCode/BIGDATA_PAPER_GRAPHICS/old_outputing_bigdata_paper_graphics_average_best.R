...
for(my_metric in my_metrics){
  ...
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/BEST_PROFILES/bigdata_returns_group_average_profile_ci")
  print(results$gret)
  RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/BEST_PROFILES/bigdata_volatility_group_average_profile_ci")
  print(results$gvol)  
  RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/BEST_PROFILES/bigdata_volume_group_average_profile_ci")
  print(results$gvolu)  
...
#   
  ...
  print("outputing an average graphic for our metric group")
  results <- RP_PlotProfile(rowProfile)
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/BEST_PROFILES/bigdata_returns_category_average_profile_ci")
  print(results$gret)
  RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/BEST_PROFILES/bigdata_volatility_category_average_profile_ci")
  print(results$gvol)  
  RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = "PAPER_PICTURES/BEST_PROFILES/bigdata_volume_category_average_profile_ci")
  print(results$gvolu)  
