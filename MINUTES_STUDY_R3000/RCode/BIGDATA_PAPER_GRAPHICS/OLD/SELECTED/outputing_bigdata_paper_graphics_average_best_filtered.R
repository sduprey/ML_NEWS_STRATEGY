...
if(doSimilarity){
  ...
  for(my_metric in my_metrics){
    ...
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/CATEGORY/"), filename = paste0(trash_counter,my_source,my_metric,"bigdata_similarity_trash_category_ep_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/CATEGORY/"), filename = paste0(trash_counter,my_source,my_metric,"bigdata_similarity_trash_category_ep_volatility"))
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/CATEGORY/"), filename = paste0(my_source,my_metric,"CAT_RET_SIM"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/CATEGORY/"), filename = paste0(my_source,my_metric,"CAT_VOL_SIM"))
    
    #   
    results <- RP_PlotMetricsTogether(agg_rowProfileGtrash,"GROUP")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/GROUP/"), filename = paste0(trash_counter_group,my_source,my_metric,"bigdata_similarity_trash_group_ep_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/GROUP/"), filename = paste0(trash_counter_group,my_source,my_metric,"bigdata_similarity_trash_group_ep_volatility"))
    #   
    results <- RP_PlotMetricsTogether(agg_rowProfileC,"CATEGORY")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/CATEGORY/"), filename = paste0(clean_counter,my_source,my_metric,"bigdata_similarity_clean_category_ep_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/CATEGORY/"), filename = paste0(clean_counter,my_source,my_metric,"bigdata_similarity_clean_category_ep_volatility"))
    #   
    results <- RP_PlotMetricsTogether(agg_rowProfileG,"GROUP")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/GROUP/"), filename = paste0(clean_counter_group,my_source,my_metric,"bigdata_similarity_clean_group_ep_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/GROUP/"), filename = paste0(clean_counter_group,my_source,my_metric,"bigdata_similarity_clean_group_ep_volatility"))
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/GROUP/"), filename = paste0(my_source,my_metric,"GROUP_RET_SIM"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SIM_FILTER/GROUP/"), filename = paste0(my_source,my_metric,"GROUP_VOL_SIM"))
...
#     agg_rowProfileG <- agg_rowProfileG[my_revert,]
    ...
    # agg_rowProfileCtrashh <- agg_rowProfileCtrash[c(3,1,2),]
    
    results <- RP_PlotMetricsTogether(agg_rowProfileCtrashh,"CATEGORY")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/CATEGORY/"), filename = paste0(short,trash_counter,my_source,my_metric,"bigdata_event_relevance_trash_category_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/CATEGORY/"), filename = paste0(short,trash_counter,my_source,my_metric,"bigdata_event_relevance_trash_category_volatility"))
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/CATEGORY/"), filename = paste0(short,my_source,my_metric,"CAT_RET_REL"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/CATEGORY/"), filename = paste0(short,my_source,my_metric,"CAT_VOL_REL"))
    
    #   
    results <- RP_PlotMetricsTogether(agg_rowProfileGtrash,"GROUP")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/GROUP/"), filename = paste0(short,trash_counter_group,my_source,my_metric,"bigdata_event_relevance_trash_group_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/GROUP/"), filename = paste0(short,trash_counter_group,my_source,my_metric,"bigdata_event_relevance_trash_group_volatility"))
    #   
    results <- RP_PlotMetricsTogether(agg_rowProfileC,"CATEGORY")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/CATEGORY/"), filename = paste0(short,clean_counter,my_source,my_metric,"bigdata_event_relevance_clean_category_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/CATEGORY/"), filename = paste0(short,clean_counter,my_source,my_metric,"bigdata_event_relevance_clean_category_volatility"))
    #   
    results <- RP_PlotMetricsTogether(agg_rowProfileG,"GROUP")
    print(results$gret)
    print(results$gvol)
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/GROUP/"), filename = paste0(short,clean_counter_group,my_source,my_metric,"bigdata_event_relevance_clean_group_return"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/GROUP/"), filename = paste0(short,clean_counter_group,my_source,my_metric,"bigdata_event_relevance_clean_group_volatility"))
    RP_ExportPlot(results$gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/GROUP/"), filename = paste0(short,my_source,my_metric,"GROUP_RET_REL"))
    RP_ExportPlot(results$gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/SOURCE_FILTER/GROUP/"), filename = paste0(short,my_source,my_metric,"GROUP_VOL_REL"))
