...
for (my_source in c("DJPR","PREMIUM_PACK","WEB_NON_PREMIUM")){
  ...
  for(my_metric in my_metrics){
    ...
    RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/",my_source,my_metric,short,"_clean_split_bigdata_returns_category_average_profile_ci"))
    print(results$gret)
