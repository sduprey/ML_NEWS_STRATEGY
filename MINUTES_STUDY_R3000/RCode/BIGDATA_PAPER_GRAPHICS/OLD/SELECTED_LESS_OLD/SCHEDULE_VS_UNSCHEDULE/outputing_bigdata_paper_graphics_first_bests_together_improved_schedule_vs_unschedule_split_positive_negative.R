...
for(my_metric in my_metrics){
  ...
  if (my_metric == "card_post_ranked_return"){
    ...
    factor <- 1.3
    rowProfilePosg[,stats_post_sign] <- factor*rowProfilePos[,stats_post_sign]
    rowProfileNegg[,stats_post_sign] <- factor*rowProfileNeg[,stats_post_sign]
    #     
  }
  
  results <- RP_PlotProfileTogether(rowProfilePosg,rowProfileNegg)
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/POSNEG/SCHEDULED_UNSCHEDULED_SPLIT_POSNEG/",my_metric,"positive_split_sent_bigdata_returns_category_average_profile_ci"))
  print(results$gret)
  ...
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/POSNEG/SCHEDULED_UNSCHEDULED_SPLIT_POSNEG/",my_metric,"negative_split_sent_bigdata_returns_category_average_profile_ci"))
  print(results$gret)
  ...
  #   
  # #     results <- RP_PlotProfileTogether(rowProfilePos,rowProfileNeg)
  # #     RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/POSNEG/",my_metric,"positive_split_sent_bigdata_returns_category_average_profile_ci"))
  # #     print(results$gret)
  #      
  ...
  #   results <- RP_PlotProfileTogether(rowProfilePos,rowProfileNeg)
  #   RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/POSNEG/",my_metric,"split_bigdata_returns_group_average_profile_ci"))
  #   print(results$gret)
  #   
