...
print(results$gret)
RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/",short,"all_together_split_sent_bigdata_returns_category_average_profile_ci"))
