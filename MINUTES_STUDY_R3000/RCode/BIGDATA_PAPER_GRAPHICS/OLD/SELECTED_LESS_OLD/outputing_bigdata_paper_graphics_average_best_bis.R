...
RP_PlotCIInterval <- function(DataFrame, Title = "", FullExportingPath=NULL) {
  ...
  if (Title == "Abnormal returns"){
    g <- g + scale_y_continuous(breaks=c(-100,-50,-25,0,25,50,100))
  }
...
for(my_metric in my_metrics){
  ...
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdata_returns_group_average_profile_ci"))
  print(results$gret)
  RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdata_volatility_group_average_profile_ci"))
  print(results$gvol)  
  RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdata_volume_group_average_profile_ci"))
  print(results$gvolu)  
  RP_ExportPlot(results$gstats,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdata_significance_group_average_profile_ci"))
  print(results$gstats)  
  RP_ExportPlot(results$gstatscombi,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdata_significance_group_average_profile_ci"))
  ...
  print("outputing an average graphic for our metric group")
  results <- RP_PlotProfile(rowProfile)
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",short,trash_counter,my_metric,"bigdata_returns_category_average_profile_ci"))
  print(results$gret)
  RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",short,trash_counter,my_metric,"bigdata_volatility_category_average_profile_ci"))
  print(results$gvol)  
  RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",short,trash_counter,my_metric,"bigdata_volume_category_average_profile_ci"))
  print(results$gvolu)  
  RP_ExportPlot(results$gstats,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",short,trash_counter,my_metric,"bigdata_significance_category_average_profile_ci"))
  print(results$gstats) 
  ##########################
  ##########################
  ##########################
