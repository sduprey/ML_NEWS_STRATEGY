...
data <- readRDS(file=paste0(outputDataPath,"metrics_clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df.rds"))
...
#   
  ...
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_returns_group_average_profile_ci"))
  print(results$gret)
  RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_volatility_group_average_profile_ci"))
  print(results$gvol)  
  RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_volume_group_average_profile_ci"))
  print(results$gvolu)  
  RP_ExportPlot(results$gstats,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_significance_group_average_profile_ci"))
  print(results$gstats)  
  RP_ExportPlot(results$gstatscombi,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"combi_bigdataf_significance_group_average_profile_ci"))
  ...
  print(g)
  # Render your graph
  RP_ExportPlot(gplot = g,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/bigdataf_group_stat_",my_metric))   
...
#   
  ...
  print("outputing an average graphic for our metric group")
  results <- RP_PlotProfile(rowProfile)
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_returns_category_average_profile_ci"))
  print(results$gret)
  RP_ExportPlot(results$gvol,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_volatility_category_average_profile_ci"))
  print(results$gvol)  
  RP_ExportPlot(results$gvolu,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_volume_category_average_profile_ci"))
  print(results$gvolu)  
  RP_ExportPlot(results$gstats,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/BEST_PROFILES/",my_metric,"bigdataf_significance_category_average_profile_ci"))
  print(results$gstats) 
  ##########################
  ##########################
  ##########################
