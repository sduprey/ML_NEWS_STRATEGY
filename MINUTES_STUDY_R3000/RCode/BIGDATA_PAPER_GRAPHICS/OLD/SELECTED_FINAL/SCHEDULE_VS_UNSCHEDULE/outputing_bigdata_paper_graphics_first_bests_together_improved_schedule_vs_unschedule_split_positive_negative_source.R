...
for(my_metric in my_metrics){
  ...
  for (my_source in c("DJPR","PREMIUM_PACK","WEB_NON_PREMIUM")){
    ...
    RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/POSNEG/",my_source, my_metric,"positive_split_sent_bigdata_returns_category_average_profile_ci"))
    print(results$gret)
    ...
    results <- RP_PlotProfileTogether(rowProfilePos,rowProfileNeg)
    RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SCHEDULED_SPLIT/POSNEG/",my_source, my_metric,"negative_split_sent_bigdata_returns_category_average_profile_ci"))
    print(results$gret)
...
save(whole_results, file = paste0(outputDataPath, paste0(my_source,"dualSentSchedule.RData")))
