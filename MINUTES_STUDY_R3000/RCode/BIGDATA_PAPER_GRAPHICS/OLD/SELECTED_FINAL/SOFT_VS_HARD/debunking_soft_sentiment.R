...
load(file = paste0(outputDataPath, "dualSentSoft.RData"))


softness<-"POSITIVETRUE"
rowProfilePOSITIVETRUE <- whole_results[softness][1]$`POSITIVETRUE`
softness <- "POSITIVEFALSE" 
rowProfilePOSITIVEFALSE <- whole_results[softness][1]$`POSITIVEFALSE`
...
rowProfileNEGATIVETRUE <- whole_results[softness][1]$`NEGATIVETRUE`
softness <- "NEGATIVEFALSE" 
rowProfileNEGATIVEFALSE <- whole_results[softness][1]$`NEGATIVEFALSE`
...
print(results$gret)
RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/SOFT_SPLIT/all_together_split_sent_bigdata_returns_category_average_profile_ci"))
