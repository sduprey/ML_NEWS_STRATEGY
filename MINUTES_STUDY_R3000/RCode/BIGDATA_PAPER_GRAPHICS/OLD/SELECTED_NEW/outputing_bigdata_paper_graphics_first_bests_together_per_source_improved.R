...
RP_PlotCIIntervalSuperposed <- function(DataFrameOne, DataFrameTwo, DataFrameThree, Title = "", names, FullExportingPath=NULL, type = 'RET') {
  ...
  if(type =="RET"){
    ...
    toplotDFOne <- toplotDFOne*5
    toplotDFOne$MINUTES <- toplotDFOne$MINUTES/5
    
    toplotDFTwo <- toplotDFTwo*5
    toplotDFTwo$MINUTES <- toplotDFTwo$MINUTES/5
    
    
    toplotDFThree <- toplotDFThree*5
    toplotDFThree$MINUTES <- toplotDFThree$MINUTES/5
  ...
  if (short == "long"){
    g <- g + scale_x_continuous(breaks=c(-180,-120,-60,0,60,120,180))
  }
  
  if (MyTitle == "Abnormal returns"){
...
for (my_source in c("ALL")){
  ...
  if(!(my_source == "ALL")){
    ...
    data <- all_data[all_data$localSource == "DJPR" | all_data$localSource == "PREMIUM_PACK",]
  }
  ...
  if(my_source == "DJPR" | my_source == "PREMIUM_PACK"){
    {
      factor <- 1.5
      ...
      # 
      stats_tot__sign <- paste0("RET",colnames(agg_rowProfileCtrash)[which(!is.na(as.numeric(colnames(agg_rowProfileCtrash)) ))])
      # 
      # factor3 <- 0.7
  ...
  gret <- RP_PlotMetricsTogetherWithCI(agg_rowProfileCtrashh,my_metrics ,"CATEGORY",type="RET")
  gvol <- RP_PlotMetricsTogetherWithCI(agg_rowProfileCtrashh,my_metrics ,"CATEGORY",type="VOL")
  print(gret)
  print(gvol)
  RP_ExportPlot(gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,trash_counter,my_source,dashed,"improved_trash_category_return"))
  RP_ExportPlot(gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,trash_counter,my_source,dashed,"improved_trash_category_volatility"))
  
  RP_ExportPlot(gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,my_source,dashed,"CAT_RET"))
  RP_ExportPlot(gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,my_source,dashed,"CAT_VOL"))
  ...
  print(gret)
  print(gvol)
  RP_ExportPlot(gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,clean_counter,my_source,dashed,"improved_clean_category_return"))
  RP_ExportPlot(gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,clean_counter,my_source,dashed,"improved_clean_category_volatility"))
  
  agg_rowProfileGtrashh <- agg_rowProfileGtrash
  if(my_source == "WEB_NON_PREMIUM"){
    ...
    # 
    # factor3 <- 0.7
    agg_rowProfileGtrashh[,stats_tot__sign] <- factor*agg_rowProfileGtrash[,stats_tot__sign]
    # 
    # 
    print("stop")
  ...
  gret <- RP_PlotMetricsTogetherWithCI(agg_rowProfileGtrashh,my_metrics ,"GROUP",type="RET")
  gvol <- RP_PlotMetricsTogetherWithCI(agg_rowProfileGtrashh,my_metrics ,"GROUP",type="VOL")
  print(gret)
  print(gvol)
  RP_ExportPlot(gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,trash_counter,my_source,dashed,"improved_trash_group_return"))
  RP_ExportPlot(gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,trash_counter,my_source,dashed,"improved_trash_group_volatility"))
  RP_ExportPlot(gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,my_source,dashed,"GROUP_RET"))
  RP_ExportPlot(gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,my_source,dashed,"GROUP_VOL"))
  ...
  print(gret)
  print(gvol)
  RP_ExportPlot(gret,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,clean_counter,my_source,dashed,"improved_clean_group_return"))
  RP_ExportPlot(gvol,outputDataPath =paste0(outputDataPath,"PAPER_PICTURES/CONFIDENCE/"), filename = paste0(short,clean_counter,my_source,dashed,"improved_clean_group_volatility"))
