...
for(my_metric in my_metrics){
  ...
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",my_metric,"split_bigdata_returns_category_average_profile_ci"))
  print(results$gret)
  ...
  results <- RP_PlotProfileTogether(rowProfilePos,rowProfileNeg)
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/CONFIDENCE_SPLIT/",my_metric,"split_bigdata_returns_group_average_profile_ci"))
  print(results$gret)
  
  
#   sentiment<-"POSITIVE"
#   rowProfile <- as.data.frame(sent_results[sentiment][1])
#   
...
#   
#   sentiment <- "NEGATIVE"
#   rowProfile <- sent_results[sentiment] 
#   
#   print("outputing an average graphic for our metric category")
#   results <- RP_PlotProfile(rowProfile)
#   
