...
for(my_metric in my_metrics){
  ...
  print(results$gret)
  RP_ExportPlot(results$gret,outputDataPath = outputDataPath,filename = paste0("PAPER_PICTURES/split_rests_",my_metric,"bigdata_split_returns_group_average_profile_ci"))
