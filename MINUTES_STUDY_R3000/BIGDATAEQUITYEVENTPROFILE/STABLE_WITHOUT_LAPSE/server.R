...
bigdata_dataTotr1000 <- readRDS(file=paste0(outputDataPath,"metrics_clean_prod_spr_r1000_bigdataf_abvol_abvol_corrado_df.rds"))
...
card_post_returnbigdata_best_group               <-readRDS(paste0(outputDataPath,filename="card_post_returnbigdataf_best_group.rds"))
card_post_ranked_returnbigdata_best_group        <-readRDS(paste0(outputDataPath,filename="card_post_ranked_returnbigdataf_best_group.rds"))
post_returnbigdata_best_group                    <-readRDS(paste0(outputDataPath,filename="post_returnbigdataf_best_group.rds"))
post_ranked_returnbigdata_best_group             <-readRDS(paste0(outputDataPath,filename="post_ranked_returnbigdataf_best_group.rds"))
post_volatilitybigdata_best_group                <-readRDS(paste0(outputDataPath,filename="post_volatilitybigdataf_best_group.rds"))
post_ranked_volatilitybigdata_best_group         <-readRDS(paste0(outputDataPath,filename="post_ranked_volatilitybigdataf_best_group.rds"))
card_pre_returnbigdata_best_group                <-readRDS(paste0(outputDataPath,filename="card_pre_returnbigdataf_best_group.rds"))
card_pre_ranked_returnbigdata_best_group         <-readRDS(paste0(outputDataPath,filename="card_pre_ranked_returnbigdataf_best_group.rds"))
pre_returnbigdata_best_group                     <-readRDS(paste0(outputDataPath,filename="pre_returnbigdataf_best_group.rds"))
pre_ranked_returnbigdata_best_group              <-readRDS(paste0(outputDataPath,filename="pre_ranked_returnbigdataf_best_group.rds"))
pre_volatilitybigdata_best_group                 <-readRDS(paste0(outputDataPath,filename="pre_volatilitybigdataf_best_group.rds"))
pre_ranked_volatilitybigdata_best_group          <-readRDS(paste0(outputDataPath,filename="pre_ranked_volatilitybigdataf_best_group.rds"))
volatility_correctionbigdata_best_group          <-readRDS(paste0(outputDataPath,filename="volatility_correctionbigdataf_best_group.rds"))
ranked_volatility_correctionbigdata_best_group   <-readRDS(paste0(outputDataPath,filename="ranked_volatility_correctionbigdataf_best_group.rds"))
return_correctionbigdata_best_group              <-readRDS(paste0(outputDataPath,filename="return_correctionbigdataf_best_group.rds"))
ranked_return_correctionbigdata_best_group       <-readRDS(paste0(outputDataPath,filename="ranked_return_correctionbigdataf_best_group.rds"))
card_return_correctionbigdata_best_group         <-readRDS(paste0(outputDataPath,filename="card_return_correctionbigdataf_best_group.rds"))
card_ranked_return_correctionbigdata_best_group  <-readRDS(paste0(outputDataPath,filename="card_ranked_return_correctionbigdataf_best_group.rds"))



card_post_returnbigdata_best_category               <-readRDS(paste0(outputDataPath,filename="card_post_returnbigdataf_best_category.rds"))
card_post_ranked_returnbigdata_best_category        <-readRDS(paste0(outputDataPath,filename="card_post_ranked_returnbigdataf_best_category.rds"))
post_returnbigdata_best_category                    <-readRDS(paste0(outputDataPath,filename="post_returnbigdataf_best_category.rds"))
post_ranked_returnbigdata_best_category             <-readRDS(paste0(outputDataPath,filename="post_ranked_returnbigdataf_best_category.rds"))
post_volatilitybigdata_best_category                <-readRDS(paste0(outputDataPath,filename="post_volatilitybigdataf_best_category.rds"))
post_ranked_volatilitybigdata_best_category         <-readRDS(paste0(outputDataPath,filename="post_ranked_volatilitybigdataf_best_category.rds"))
card_pre_returnbigdata_best_category                <-readRDS(paste0(outputDataPath,filename="card_pre_returnbigdataf_best_category.rds"))
card_pre_ranked_returnbigdata_best_category         <-readRDS(paste0(outputDataPath,filename="card_pre_ranked_returnbigdataf_best_category.rds"))
pre_returnbigdata_best_category                     <-readRDS(paste0(outputDataPath,filename="pre_returnbigdataf_best_category.rds"))
pre_ranked_returnbigdata_best_category              <-readRDS(paste0(outputDataPath,filename="pre_ranked_returnbigdataf_best_category.rds"))
pre_volatilitybigdata_best_category                 <-readRDS(paste0(outputDataPath,filename="pre_volatilitybigdataf_best_category.rds"))
pre_ranked_volatilitybigdata_best_category          <-readRDS(paste0(outputDataPath,filename="pre_ranked_volatilitybigdataf_best_category.rds"))
volatility_correctionbigdata_best_category          <-readRDS(paste0(outputDataPath,filename="volatility_correctionbigdataf_best_category.rds"))
ranked_volatility_correctionbigdata_best_category   <-readRDS(paste0(outputDataPath,filename="ranked_volatility_correctionbigdataf_best_category.rds"))
return_correctionbigdata_best_category              <-readRDS(paste0(outputDataPath,filename="return_correctionbigdataf_best_category.rds"))
ranked_return_correctionbigdata_best_category       <-readRDS(paste0(outputDataPath,filename="ranked_return_correctionbigdataf_best_category.rds"))
card_return_correctionbigdata_best_category         <-readRDS(paste0(outputDataPath,filename="card_return_correctionbigdataf_best_category.rds"))
card_ranked_return_correctionbigdata_best_category  <-readRDS(paste0(outputDataPath,filename="card_ranked_return_correctionbigdataf_best_category.rds"))
...
############################################################################################################################################################################################################################################################
# rpna_dataTotr1000 <- readRDS(file=paste0(outputDataPath,"nnew_spr_r1000_rpna_abvol_abvol_corrado_df.rds"))
rpna_dataTotr1000 <- readRDS(file=paste0(outputDataPath,"metrics_clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df.rds"))
...
card_post_returnrpna_best_group               <-readRDS(paste0(outputDataPath,filename="card_post_returnrpnaf_best_group.rds"))
card_post_ranked_returnrpna_best_group        <-readRDS(paste0(outputDataPath,filename="card_post_ranked_returnrpnaf_best_group.rds"))
post_returnrpna_best_group                    <-readRDS(paste0(outputDataPath,filename="post_returnrpnaf_best_group.rds"))
post_ranked_returnrpna_best_group             <-readRDS(paste0(outputDataPath,filename="post_ranked_returnrpnaf_best_group.rds"))
post_volatilityrpna_best_group                <-readRDS(paste0(outputDataPath,filename="post_volatilityrpnaf_best_group.rds"))
post_ranked_volatilityrpna_best_group         <-readRDS(paste0(outputDataPath,filename="post_ranked_volatilityrpnaf_best_group.rds"))
card_pre_returnrpna_best_group                <-readRDS(paste0(outputDataPath,filename="card_pre_returnrpnaf_best_group.rds"))
card_pre_ranked_returnrpna_best_group         <-readRDS(paste0(outputDataPath,filename="card_pre_ranked_returnrpnaf_best_group.rds"))
pre_returnrpna_best_group                     <-readRDS(paste0(outputDataPath,filename="pre_returnrpnaf_best_group.rds"))
pre_ranked_returnrpna_best_group              <-readRDS(paste0(outputDataPath,filename="pre_ranked_returnrpnaf_best_group.rds"))
pre_volatilityrpna_best_group                 <-readRDS(paste0(outputDataPath,filename="pre_volatilityrpnaf_best_group.rds"))
pre_ranked_volatilityrpna_best_group          <-readRDS(paste0(outputDataPath,filename="pre_ranked_volatilityrpnaf_best_group.rds"))
volatility_correctionrpna_best_group          <-readRDS(paste0(outputDataPath,filename="volatility_correctionrpnaf_best_group.rds"))
ranked_volatility_correctionrpna_best_group   <-readRDS(paste0(outputDataPath,filename="ranked_volatility_correctionrpnaf_best_group.rds"))
return_correctionrpna_best_group              <-readRDS(paste0(outputDataPath,filename="return_correctionrpnaf_best_group.rds"))
ranked_return_correctionrpna_best_group       <-readRDS(paste0(outputDataPath,filename="ranked_return_correctionrpnaf_best_group.rds"))
card_return_correctionrpna_best_group         <-readRDS(paste0(outputDataPath,filename="card_return_correctionrpnaf_best_group.rds"))
card_ranked_return_correctionrpna_best_group  <-readRDS(paste0(outputDataPath,filename="card_ranked_return_correctionrpnaf_best_group.rds"))



card_post_returnrpna_best_category               <-readRDS(paste0(outputDataPath,filename="card_post_returnrpnaf_best_category.rds"))
card_post_ranked_returnrpna_best_category        <-readRDS(paste0(outputDataPath,filename="card_post_ranked_returnrpnaf_best_category.rds"))
post_returnrpna_best_category                    <-readRDS(paste0(outputDataPath,filename="post_returnrpnaf_best_category.rds"))
post_ranked_returnrpna_best_category             <-readRDS(paste0(outputDataPath,filename="post_ranked_returnrpnaf_best_category.rds"))
post_volatilityrpna_best_category                <-readRDS(paste0(outputDataPath,filename="post_volatilityrpnaf_best_category.rds"))
post_ranked_volatilityrpna_best_category         <-readRDS(paste0(outputDataPath,filename="post_ranked_volatilityrpnaf_best_category.rds"))
card_pre_returnrpna_best_category                <-readRDS(paste0(outputDataPath,filename="card_pre_returnrpnaf_best_category.rds"))
card_pre_ranked_returnrpna_best_category         <-readRDS(paste0(outputDataPath,filename="card_pre_ranked_returnrpnaf_best_category.rds"))
pre_returnrpna_best_category                     <-readRDS(paste0(outputDataPath,filename="pre_returnrpnaf_best_category.rds"))
pre_ranked_returnrpna_best_category              <-readRDS(paste0(outputDataPath,filename="pre_ranked_returnrpnaf_best_category.rds"))
pre_volatilityrpna_best_category                 <-readRDS(paste0(outputDataPath,filename="pre_volatilityrpnaf_best_category.rds"))
pre_ranked_volatilityrpna_best_category          <-readRDS(paste0(outputDataPath,filename="pre_ranked_volatilityrpnaf_best_category.rds"))
volatility_correctionrpna_best_category          <-readRDS(paste0(outputDataPath,filename="volatility_correctionrpnaf_best_category.rds"))
ranked_volatility_correctionrpna_best_category   <-readRDS(paste0(outputDataPath,filename="ranked_volatility_correctionrpnaf_best_category.rds"))
return_correctionrpna_best_category              <-readRDS(paste0(outputDataPath,filename="return_correctionrpnaf_best_category.rds"))
ranked_return_correctionrpna_best_category       <-readRDS(paste0(outputDataPath,filename="ranked_return_correctionrpnaf_best_category.rds"))
card_return_correctionrpna_best_category         <-readRDS(paste0(outputDataPath,filename="card_return_correctionrpnaf_best_category.rds"))
card_ranked_return_correctionrpna_best_category  <-readRDS(paste0(outputDataPath,filename="card_ranked_return_correctionrpnaf_best_category.rds"))
