...
# datag <- readRDS(file=paste0(outputDataPath,bootstrap_CI,"gprod_r1000_rpna_abvol_abvol_corrado_df.rds"))
# data <- rbind(data,datag)
data <- readRDS(file=paste0(outputDataPath,bootstrap_CI,"lprod_r1000_rpna_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "prod_spr_r1000_rpnaf_abvol_abvol_corrado_df")
print("spread saved")
...
data <- readRDS(file=paste0(outputDataPath,"prod_spr_r1000_rpnaf_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df")
print("clean saved")
...
data <- readRDS(file=paste0(outputDataPath,"clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "cor_clean_clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df")
print("clean corrado")
...
data <- readRDS(file=paste0(outputDataPath,"cor_clean_clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "metrics_clean_prod_spr_r1000_rpnaf_abvol_abvol_corrado_df")
print("metrics saved")
...
# 
# RP_SaveDataFrame(all_group_events, outputDataPath = outputDataPath, filename = "prod_rpnaf_all_group_events")
# RP_SaveDataFrame(all_category_events, outputDataPath = outputDataPath, filename = "prod_rpnaf_all_category_events")
# 
...
for(my_metric in my_metrics){
  ...
  gpfilename <- paste0(my_metric,"rpnaf_best_group")
#   if (gpfilename == "post_returnrpnaf_best_group" ){
#     print("found")
#   }
  ...
  catfilename <- paste0(my_metric,"rpnaf_best_category")
