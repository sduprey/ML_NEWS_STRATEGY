...
data$event_number_event_filtering <- 2*data$event_number_event_filtering
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "prod_spr_r1000_bigdata_abvol_abvol_corrado_df")
print("spread saved")
...
data <- readRDS(file=paste0(outputDataPath,"prod_spr_r1000_bigdata_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "clean_prod_spr_r1000_bigdata_abvol_abvol_corrado_df")
print("clean saved")
...
data <- readRDS(file=paste0(outputDataPath,"clean_prod_spr_r1000_bigdata_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "cor_clean_clean_prod_spr_r1000_bigdata_abvol_abvol_corrado_df")
print("clean corrado")
...
data <- readRDS(file=paste0(outputDataPath,"cor_clean_clean_prod_spr_r1000_bigdata_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "metrics_clean_prod_spr_r1000_bigdata_abvol_abvol_corrado_df")
print("metrics saved")
...
RP_SaveDataFrame(dataGroupBest, outputDataPath = outputDataPath, filename = "clean_prod_bigdata_best_profile_group_ordered_r1000_corrado_df")
...
RP_SaveDataFrame(dataCategoryBest, outputDataPath = outputDataPath, filename = "clean_prod_bigdata_best_profile_category_ordered_r1000_corrado_df")
...
for(my_metric in my_metrics){
  ...
  gpfilename <- paste0(my_metric,"bigdata_best_group")
  #   if (gpfilename == "post_returnbigdata_best_group" ){
  #     print("found")
  #   }
  ...
  catfilename <- paste0(my_metric,"bigdata_best_category")
