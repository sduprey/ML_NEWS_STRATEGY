...
shinyUI(fluidPage(    
  ...
  fluidRow(      
    ...
    #            ),
    column(8,
#            navlistPanel(selected="Comparative Plots", id='mynavlist',
#                                                tabPanel(title ="Comparative Plots",
#                                                         # value = "tab1",
#                                                         plotOutput("eventMinutesPlotHigh"),
#                                                         plotOutput("eventMinutesPlotLow")), 
#                                                tabPanel(title="Best Profiles Summary",
#                                                         # value="tab2",
#                                                         DT::dataTableOutput("best_profiles_table")),
#                                                tabPanel(title = "Best Profile Plot",
#                                                         # value="tab3",
...
#            )
    ...
    column(2,
           ...
           #            selectInput("sec_russell_universe",
           #                        "RUSSELL UNIVERSE",
           #                        c("R1000","R2000")),
           ...
           selectInput("sec_my_plot",
                       "PLOT TYPE",
                       c("RETURNS_SIGNIFICANCE","VOL_VOL"),
                       "RETURNS"),
           
           checkboxInput("sec_sort_profiles", "Sort", FALSE),
