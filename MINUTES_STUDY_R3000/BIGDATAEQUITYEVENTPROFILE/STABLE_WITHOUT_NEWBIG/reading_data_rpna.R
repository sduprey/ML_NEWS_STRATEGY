...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "cor_clean_clean_prod_spr_r1000_rpna_abvol_abvol_corrado_df")
print("clean corrado")
...
data <- readRDS(file=paste0(outputDataPath,"cor_clean_clean_prod_spr_r1000_rpna_abvol_abvol_corrado_df.rds"))
...
RP_SaveDataFrame(data, outputDataPath = outputDataPath, filename = "metrics_clean_prod_spr_r1000_rpna_abvol_abvol_corrado_df")
print("metrics saved")
...
for(my_metric in my_metrics){
  ...
  gpfilename <- paste0(my_metric,"rpna_best_group")
#   if (gpfilename == "post_returnrpna_best_group" ){
#     print("found")
#   }
  ...
  catfilename <- paste0(my_metric,"rpna_best_category")
