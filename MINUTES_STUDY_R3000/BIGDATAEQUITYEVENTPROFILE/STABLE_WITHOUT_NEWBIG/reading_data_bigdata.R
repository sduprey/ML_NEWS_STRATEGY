...
RP_SaveDataFrame(all_group_events, outputDataPath = outputDataPath, filename = "prod_bigdata_all_group_events")
RP_SaveDataFrame(all_category_events, outputDataPath = outputDataPath, filename = "prod_bigdata_all_category_events")
